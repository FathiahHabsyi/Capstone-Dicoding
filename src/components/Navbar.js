...
import FetchWork from '../assets/images/icons/FetchWork.png'
  ...
  return (
    <div>
        ...
        <div className="container">
          <a className="navbar-brand" href="#"><img src={FetchWork} alt="logo"/></a>
          ...
          <div className="collapse navbar-collapse" id="navmenu">
            <ul className="navbar-nav mx-auto">
              <li className="nav-item mx-2">
                <a className="nav-link" href="#find">Find Job</a>
              </li>
              <li className="nav-item mx-2">
