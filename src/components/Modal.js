          ...
          <div className="modal-content">
            ...
            <div className="modal-body text-center">
              ...
              <div className="d-grid gap-2 col-6 mx-auto mb-3">
                <button className="btn btn-outline-primary" type="submit"><img src={iconGoogle} className="img-google me-3" width="20"/>Log in with Google</button>
                <button className="btn btn-outline-primary" type="submit"><img src={iconFacebook} className="img-google me-3" width="20"/>Log in with Facebook</button>
              </div>
